...
# This script was set up to analyze Dermo 2015 transcriptome data from CLC alignment and assembly
...
C_vir_rtracklayer <- readGFF("/Users/erinroberts/Documents/PhD_Research/Chapter_1_Apoptosis Paper/Chapter1_Apoptosis_Transcriptome_Analyses_2019/DATA ANALYSIS/apoptosis_data_pipeline/DESeq2/C_VIRGINICA_PIPELINE/ref_C_virginica-3.0_top_level.gff3")
C_vir_rtracklayer <- as.data.frame(C_vir_rtracklayer)

# load csv with final transcript_GO terms
...
### CODE BELOW IS HOW ORIGINAL MATCHING TO GO TERMS WAS COMPLETED, DO NOT RUN EVERY TIME ###
...
### MARCH 6TH, UPDATE CODE BELOW AND ABOVE SO THAT I SEARCH IN C_vir_rtracklayer_apop_product_final
