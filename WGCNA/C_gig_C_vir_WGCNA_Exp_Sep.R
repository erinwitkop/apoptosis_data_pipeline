...
# Overlap with DEG results
C_vir_apop_LFC_Probiotic <- C_vir_apop_LFC %>% filter(experiment =="Probiotic")
nrow(C_vir_apop_LFC_Probiotic) #17
Probiotic_module_apop_df_DEG <- full_join(C_vir_apop_LFC_Probiotic, Probiotic_module_apop_df  )
...
# Use function to lookup all apop names for each significant module
names(Pro_RE22_RE22_moduleTraitCor_Pval_df_sig_list_rm) <- c("turquoise", "cyan" ,     "red"   )
...
## Assess whether Pro_RE22 (all, not separated) and ROD_Res modules are preserved ##
...
## Assess whether Pro_RE22_RE22 and ROD_Res modules are preserved ##
...
# Plot module preservation
# remember - low median rank means high preservation
ggplot(Pro_RE22_ROD_Res_stats_MR_order, aes(x= moduleSize, y = medianRank.pres, color = mod_name)) + 
  geom_point() + xlab("Module Size") + ylab("Median Rank") + geom_text(aes(label=mod_name))

# were any of the preserved modules also significant?
Pro_RE22_RE22_only_SIG_ROD_Res_preserved <- Pro_RE22_ROD_Res_stats_preserved[Pro_RE22_ROD_Res_stats_preserved$mod_names %in% Pro_RE22_RE22_moduleTraitCor_Pval_df_sig_list_rm,]
Pro_RE22_RE22_only_ROD_RES_SIG_preserved <- Pro_RE22_ROD_Res_stats_preserved[Pro_RE22_ROD_Res_stats_preserved$mod_names %in% ROD_Res_moduleTraitCor_Pval_df_sig_list_rm,]


### Assess whether Pro_RE22 (all not separated) and ROD_Sus modules are preserved
...
# # blue, red (brown )
# 
# Pro_RE22_RI_SIG_ROD_Sus_preserved_all <- Pro_RE22_Sus_stats_preserved[Pro_RE22_Sus_stats_preserved$mod_names %in% Pro_RE22_RI_moduleTraitCor_Pval_df_sig_list_rm,]
# # blue, red
# Pro_RE22_S4_SIG_ROD_Sus_preserved_all <- Pro_RE22_Sus_stats_preserved[Pro_RE22_Sus_stats_preserved$mod_names %in%  Pro_RE22_S4_moduleTraitCor_Pval_df_sig_list_rm,]
# # blue, red
# Pro_RE22_RE22_SIG_ROD_Sus_preserved_all <- Pro_RE22_Sus_stats_preserved[Pro_RE22_Sus_stats_preserved$mod_names %in%  Pro_RE22_moduleTraitCor_Pval_df_sig_list_rm,]
# # blue, red
# Pro_RE22_ROD_SUS_SIG_preserved_all <- Pro_RE22_Sus_stats_preserved[Pro_RE22_Sus_stats_preserved$mod_names %in%  ROD_Sus_moduleTraitCor_Pval_df_sig_list_rm,]
# # brown
# # Conclusion: ROD Sus and Pro_RE22 share brown, red, blue in terms of preservation, though there isn't overlap between modules significant for both

## Assess whether Pro_RE22_RE22 and ROD_Sus modules are preserved ##
...
# were any of the preserved modules also significant?
Pro_RE22_RE22_only_SIG_ROD_Sus_preserved <- Pro_RE22_ROD_Sus_stats_preserved[Pro_RE22_ROD_Sus_stats_preserved$mod_names %in% Pro_RE22_RE22_moduleTraitCor_Pval_df_sig_list_rm,]
Pro_RE22_RE22_only_ROD_Sus_SIG_preserved <- Pro_RE22_ROD_Sus_stats_preserved[Pro_RE22_ROD_Sus_stats_preserved$mod_names %in% ROD_Sus_moduleTraitCor_Pval_df_sig_list_rm,]
...
# 
## Assess whether Pro_RE22_RE22 and Dermo_Tol modules are preserved ##
...
Pro_RE22_RE22_multiColor = list(Pro_RE22_RE22 = Pro_RE22_RE22_moduleColors) 
Pro_RE22_RE22_Dermo_mp =modulePreservation(Pro_RE22_RE22_Dermo_multiExpr, Pro_RE22_RE22_multiColor,
                                      referenceNetworks=1,
                                      verbose=3,
                                      networkType="signed hybrid", # use same signed hybrid as before
                                      corFnc = "bicor", # use recommended bicor as before 
...
Pro_RE22_RE22_Dermo_stats_order <- Pro_RE22_RE22_Dermo_stats[order(-Pro_RE22_RE22_Dermo_stats[,2]),c(1:2)]
...
Pro_RE22_RE22_Dermo_stats_MR_order <- Pro_RE22_RE22_Dermo_stats_MR[order(-Pro_RE22_RE22_Dermo_stats_MR[,2]),]
...
Pro_RE22_RE22_Dermo_Tol_SIG_RE22_preserved_all <- Pro_RE22_RE22_Dermo_stats_preserved[Pro_RE22_RE22_Dermo_stats_preserved$mod_name %in% Pro_RE22_Pro_moduleTraitCor_Pval_df_sig_list_rm,]
...
Dermo_Sus_ROD_Sus <-ROD_Dermo_Sus_stats_MR_order_less20[ROD_Dermo_Sus_stats_MR_order_less20$mod_name %in%Dermo_Sus_moduleTraitCor_Pval_df_sig_list_rm,]
# 0
Dermo_Sus_ROD_Sus_ROD <-ROD_Dermo_Sus_stats_MR_order_less20[ROD_Dermo_Sus_stats_MR_order_less20$mod_name %in%ROD_Sus_moduleTraitCor_Pval_df_sig_list_rm,]
# turqoise module is preserved and significant in the ROD challenge
...
C_vir_Pro_moduleTraitCor[[3]] = cor(C_vir_Pro_consMEs[[3]]$data, C_vir_Pro_coldata_all[[3]]$data, use = "p")
C_vir_Pro_moduleTraitPvalue[[3]] = corPvalueFisher(C_vir_Pro_moduleTraitCor[[3]], exprSize_Cvir_Pro$nSamples[3])
...
C_vir_Pro_consensusPvalue[C_vir_Bac_negative] = pmax(C_vir_Pro_moduleTraitPvalue[[1]][C_vir_Pro_negative], C_vir_Pro_moduleTraitPvalue[[2]][C_vir_Pro_negative])
# Find consensus positive correlations
C_vir_Pro_positive = C_vir_Pro_moduleTraitCor[[1]] > 0 & C_vir_Bac_moduleTraitCor[[2]] > 0
C_vir_Pro_consensusCor[C_vir_Bac_positive] = pmin(C_vir_Bac_moduleTraitCor[[1]][C_vir_Bac_positive], C_vir_Bac_moduleTraitCor[[2]][C_vir_Bac_positive])
C_vir_Pro_consensusPvalue[C_vir_Bac_positive] = pmax(C_vir_Bac_moduleTraitPvalue[[1]][C_vir_Bac_positive], C_vir_Bac_moduleTraitPvalue[[2]][C_vir_Bac_positive])
...
# Assess whether deLorg_Sus and He have conservation (since He was also susceptible)
...
deLorg_Sus_Tol_stats_MR <- deLorg_He_stats_MR  [,c("moduleSize","medianRank.pres")]
deLorg_Sus_Tol_stats_MR_order <- deLorg_He_stats_MR [order(-deLorg_He_stats_MR [,2]),]
deLorg_Sus_Tol_stats_MR_order_less20 <- deLorg_He_stats_MR_order %>% rownames_to_column("mod_name") %>% filter(medianRank.pres < 20)
...
# Were any of these preserved modules significant in deLorg_Sus and He
deLorg_Sus_preserved_all <- deLorg_Sus_Tol_stats_preserved[deLorg_Sus_Tol_stats_preserved$mod_name %in% deLorg_Sus_moduleTraitCor_Pval_df_sig_list_rm,]
# mod_name moduleSize Zsummary.pres
# 3  turquoise       1000     20.453268
# 4       blue       1000     17.552898
# 11    purple        208      6.741922
deLorg_Tol_preserved_all <- deLorg_Sus_Tol_stats_preserved[deLorg_Sus_Tol_stats_preserved$mod_name %in% deLorg_Res_moduleTraitCor_Pval_df_sig_list_rm,]
# mod_name moduleSize Zsummary.pres
...
# this one is taking a very long time need to run over night 
...
# Were any of these preserved modules significant in deLorg_Sus and He
Zhang_He_Zhang_preserved_all <- Zhang_He_stats_preserved[Zhang_He_stats_preserved$mod_name %in% Zhang_moduleTraitCor_Pval_NV_df_sig_list_rm,]
