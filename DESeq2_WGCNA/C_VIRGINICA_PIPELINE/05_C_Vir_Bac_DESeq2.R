...
#make the LOC row a .csv so you can use it to BLAST2GO
write.csv(resRODTran_05_FULL_ENTREZGENE_DATA$gene_ID, file = "C_vir_LOC_BLAST2GO.csv")
...
write.csv(resRODTran_05_FULL_ENTREZGENE_DATA$gene_ID, file="resRODTran_05_FULL_ENTREZGENE_DATA.csv")
...
ROD_Sig_PLOT2 <- ROD_Sig_PLOT + geom_text(data=label.ROD.df, aes(x=description, y=log2FoldChange), label = c("***")) +
  ...
  scale_x_discrete(name="Transcript Annotation", limits=c("protein kinase C iota type-like",
...
ROD_Sig_PLOT2_01 <- ROD_Sig_PLOT_01 + geom_text(data=label.ROD.df, aes(x=description, y=log2FoldChange), label = c("***")) +
  ...
  theme(axis.line = element_line(colour = "black", size = 0.5, linetype = "solid")) +
  scale_x_discrete(name="Transcript Annotation", limits=c("caspase-7-like (2)",
                                                "caspase-7-like (1)",
                                                "caspase-3-like",
                                                "caspase-8-like",
                                                "caspase-2-like",
...
ROD_GIMAP_IAP_combined <- rbind(GIMAP, IAP, IAP2)
ROD_GIMAP_IAP_combined_SIG <- ROD_GIMAP_IAP_combined %>% filter(Significance == "significant")
#put two columns together to make the description column unique for the graphing process, use tidyr unite()
ROD_GIMAP_IAP_combined_2 <- unite(ROD_GIMAP_IAP_combined, description3, c(description, GeneID), remove=FALSE)
GIMAP_IAP_sig <- ROD_GIMAP_IAP_combined_2 %>% filter(Significance == "significant")
write.csv(ROD_GIMAP_IAP_combined_2, file= "ROD_GIMAP_IAP_combined_2.csv")
ROD_GIMAP_IAP_combined_3<- read.csv(file="ROD_GIMAP_IAP_combined_2.csv", header=TRUE)

#labels for signifiance with *= p <0.05
label.GIMAP_IAP.df <- data.frame(description3= c("baculoviral IAP repeat-containing protein 7-like_111100416",
                                                 "GTPase IMAP family member 4-like_111103161",
                                                 "GTPase IMAP family member 4-like_111105333 (1)",
                                                 "GTPase IMAP family member 4-like_111106081",
                                                 "GTPase IMAP family member 4-like_111110875 (1)",
                                                 "GTPase IMAP family member 7-like_111111454",
                                                 "GTPase IMAP family member 7-like_111112005"), log2FoldChange=c(-3.0,
                                                                                                                 -5.5,
                                                                                                                 -8.0,
                                                                                                                 4.5,
                                                                                                                 -23.5,
                                                                                                                 -6.0,
                                                                                                                 -6.5))
ROD_GIMAP_IAP_1 <- ggplot(ROD_GIMAP_IAP_combined_3) + 
  geom_col(aes(x=description3, y=log2FoldChange, fill=Type)) + 
  theme(axis.text.x = element_text(angle = 75, hjust = 1)) + geom_hline(yintercept=0.0) +
  scale_y_continuous(name ="log2 Fold Change", breaks = scales::pretty_breaks(n = 20)) + 
  ggtitle("GIMAP and IAP Apoptosis Genes in C. virginica after ROD Challenge") + 
  theme(plot.title = element_text(size=10)) + theme(plot.title = element_text(hjust = 0.5))
...
"baculoviral IAP repeat-containing protein 2-like_111100408 (2)",
                                                          ...
                                                          "baculoviral IAP repeat-containing protein 2-like_111101035 (1)",
                                                          "baculoviral IAP repeat-containing protein 2-like_111101035 (2)",
                                                          "baculoviral IAP repeat-containing protein 2-like_111101035 (3)",
                                                          "baculoviral IAP repeat-containing protein 2-like_111101689 (1)",
                                                          "baculoviral IAP repeat-containing protein 2-like_111101689 (2)",
                                                          "baculoviral IAP repeat-containing protein 2-like_111101689 (3)",
                                                          "baculoviral IAP repeat-containing protein 2-like_111101689 (4)",
                                                          "baculoviral IAP repeat-containing protein 2-like_111102770 ",
                                                          "baculoviral IAP repeat-containing protein 2-like_111102858",
                                                          "baculoviral IAP repeat-containing protein 2-like_111102964 (1)",
                                                          "baculoviral IAP repeat-containing protein 2-like_111102964 (2)",
                                                          "baculoviral IAP repeat-containing protein 2-like_111103428 ",
                                                          "baculoviral IAP repeat-containing protein 2-like_111103826 (1)",
                                                          "baculoviral IAP repeat-containing protein 2-like_111103826 (2)",
                                                          "baculoviral IAP repeat-containing protein 2-like_111105503 (1)",
                                                          "baculoviral IAP repeat-containing protein 2-like_111105503 (2)",
                                                          "baculoviral IAP repeat-containing protein 2-like_111106726",
                                                          "baculoviral IAP repeat-containing protein 2-like_111123894 (1)",
                                                          "baculoviral IAP repeat-containing protein 2-like_111123894 (2)",
                                                          "baculoviral IAP repeat-containing protein 3-like_111100470",
                                                          ...
                                                          "baculoviral IAP repeat-containing protein 3-like_111100471 (4)",
                                                          ...
                                                          "baculoviral IAP repeat-containing protein 3-like_111103270",
                                                          "baculoviral IAP repeat-containing protein 3-like_111103392",
                                                          "baculoviral IAP repeat-containing protein 3-like_111103427",
                                                          ...
                                                          "baculoviral IAP repeat-containing protein 5-like_111119408",
                                                          ...
                                                          "baculoviral IAP repeat-containing protein 7-A-like_111103982 (2)",
                                                          "baculoviral IAP repeat-containing protein 7-A-like_111103982 (3)",
                                                          ...
                                                          "baculoviral IAP repeat-containing protein 7-like_111100633",
                                                          "baculoviral IAP repeat-containing protein 7-like_111105494",
                                                          "baculoviral IAP repeat-containing protein 7-like_111136287",
                                                          "baculoviral IAP repeat-containing protein 8-like_111103158",
                                                          "baculoviral IAP repeat-containing protein 8-like_111104229",
                                                          "baculoviral IAP repeat-containing protein 8-like_111109770",
                                                          "GTPase IMAP family member 4-like_111102552",
                                                          "GTPase IMAP family member 4-like_111103040",
                                                          "GTPase IMAP family member 4-like_111103161",
                                                          "GTPase IMAP family member 4-like_111103458",
                                                          "GTPase IMAP family member 4-like_111103460",
                                                          "GTPase IMAP family member 4-like_111105333 (1)",
                                                          ...
                                                          "GTPase IMAP family member 4-like_111108760",
                                                          "GTPase IMAP family member 4-like_111109343",
                                                          ...
                                                          "GTPase IMAP family member 4-like_111109853",
                                                          "GTPase IMAP family member 4-like_111109878",
                                                          "GTPase IMAP family member 4-like_111110115",
                                                          "GTPase IMAP family member 4-like_111110875 (1)",
                                                          "GTPase IMAP family member 4-like_111110875 (2)",
                                                          "GTPase IMAP family member 4-like_111115902",
                                                          ...
                                                          "GTPase IMAP family member 4-like_111129930",
                                                          ...
                                                          "GTPase IMAP family member 4-like_111130155",
                                                          "GTPase IMAP family member 4-like_111132212",
                                                          "GTPase IMAP family member 7-like_111106989",
                                                          "GTPase IMAP family member 7-like_111108121 (1)",
                                                          "GTPase IMAP family member 7-like_111108121 (2)",
                                                          "GTPase IMAP family member 7-like_111108220",
                                                          "GTPase IMAP family member 7-like_111108559",
                                                          "GTPase IMAP family member 7-like_111109557",
                                                          "GTPase IMAP family member 7-like_111109668",
                                                          "GTPase IMAP family member 7-like_111110321",
                                                          "GTPase IMAP family member 7-like_111111454",
                                                          "GTPase IMAP family member 7-like_111112005",
                                                          ...
                                                          "putative inhibitor of apoptosis_111101016",
                                                          "putative inhibitor of apoptosis_111101682",
                                                          ...
                                                          "putative inhibitor of apoptosis_111104637 (1)",
                                                          "putative inhibitor of apoptosis_111104637 (2)"),
label=c("baculoviral IAP repeat-containing protein 2-like_111100408 (1)" = "BIR IAP 2-like",
        ...
        "baculoviral IAP repeat-containing protein 2-like_111101035 (1)" ="BIR IAP 2-like",
        "baculoviral IAP repeat-containing protein 2-like_111101035 (2)" ="BIR IAP 2-like",
        "baculoviral IAP repeat-containing protein 2-like_111101035 (3)" ="BIR IAP 2-like",
        ...
        "baculoviral IAP repeat-containing protein 2-like_111101689 (3)"="BIR IAP 2-like",
        "baculoviral IAP repeat-containing protein 2-like_111101689 (4)"="BIR IAP 2-like",
        "baculoviral IAP repeat-containing protein 2-like_111102770 "="BIR IAP 2-like",
        "baculoviral IAP repeat-containing protein 2-like_111102858"="BIR IAP 2-like",
        "baculoviral IAP repeat-containing protein 2-like_111102964 (1)"="BIR IAP 2-like",
        "baculoviral IAP repeat-containing protein 2-like_111102964 (2)"="BIR IAP 2-like",
        "baculoviral IAP repeat-containing protein 2-like_111103428 "="BIR IAP 2-like",
        ...
        "baculoviral IAP repeat-containing protein 2-like_111105503 (1)"="BIR IAP 2-like",
        "baculoviral IAP repeat-containing protein 2-like_111105503 (2)"="BIR IAP 2-like",
        "baculoviral IAP repeat-containing protein 2-like_111106726"="BIR IAP 2-like",
        "baculoviral IAP repeat-containing protein 2-like_111123894 (1)"="BIR IAP 2-like",
        "baculoviral IAP repeat-containing protein 2-like_111123894 (2)"="BIR IAP 2-like",
        "baculoviral IAP repeat-containing protein 3-like_111100470"="BIR IAP 3-like",
        ...
        "baculoviral IAP repeat-containing protein 3-like_111100471 (4)"="BIR IAP 3-like",
        ...
        "baculoviral IAP repeat-containing protein 3-like_111103270"="BIR IAP 3-like",
        "baculoviral IAP repeat-containing protein 3-like_111103392"="BIR IAP 3-like",
        "baculoviral IAP repeat-containing protein 3-like_111103427"="BIR IAP 3-like",
        ...
        "baculoviral IAP repeat-containing protein 5-like_111119408"="BIR IAP 5-like",
        ...
        "baculoviral IAP repeat-containing protein 7-A-like_111103982 (2)"="BIR IAP 7-A-like",
        "baculoviral IAP repeat-containing protein 7-A-like_111103982 (3)"="BIR IAP 7-A-like",
        ...
        "baculoviral IAP repeat-containing protein 7-like_111100633"="BIR IAP 7-like",
        "baculoviral IAP repeat-containing protein 7-like_111105494"="BIR IAP 7-like",
        "baculoviral IAP repeat-containing protein 7-like_111136287"="BIR IAP 7-like",
        ...
        "baculoviral IAP repeat-containing protein 8-like_111109770"="BIR IAP 8-like",
        "GTPase IMAP family member 4-like_111102552"="GIMAP 4-like",
        "GTPase IMAP family member 4-like_111103040"="GIMAP 4-like",
        "GTPase IMAP family member 4-like_111103161"="GIMAP 4-like",
        "GTPase IMAP family member 4-like_111103458"="GIMAP 4-like",
        "GTPase IMAP family member 4-like_111103460"="GIMAP 4-like",
        ...
        "GTPase IMAP family member 4-like_111106081"="GIMAP 4-like",
        ...
        "GTPase IMAP family member 4-like_111108760"="GIMAP 4-like",
        "GTPase IMAP family member 4-like_111109343"="GIMAP 4-like",
        ...
        "GTPase IMAP family member 4-like_111109853"="GIMAP 4-like",
        "GTPase IMAP family member 4-like_111109878"="GIMAP 4-like",
        "GTPase IMAP family member 4-like_111110115"="GIMAP 4-like",
        "GTPase IMAP family member 4-like_111110875 (1)"="GIMAP 4-like",
        "GTPase IMAP family member 4-like_111110875 (2)"="GIMAP 4-like",
        "GTPase IMAP family member 4-like_111115902"="GIMAP 4-like",
        ...
        "GTPase IMAP family member 4-like_111129930"="GIMAP 4-like",
        ...
        "GTPase IMAP family member 4-like_111130155"="GIMAP 4-like",
        "GTPase IMAP family member 4-like_111132212"="GIMAP 4-like",
        "GTPase IMAP family member 7-like_111106989"="GIMAP 7-like",
        "GTPase IMAP family member 7-like_111108121 (1)"="GIMAP 7-like",
        "GTPase IMAP family member 7-like_111108121 (2)"="GIMAP 7-like",
        "GTPase IMAP family member 7-like_111108220"="GIMAP 7-like",
        "GTPase IMAP family member 7-like_111108559"="GIMAP 7-like",
        "GTPase IMAP family member 7-like_111109557"="GIMAP 7-like",
        "GTPase IMAP family member 7-like_111109668"="GIMAP 7-like",
        "GTPase IMAP family member 7-like_111110321"="GIMAP 7-like",
        "GTPase IMAP family member 7-like_111111454"="GIMAP 7-like",
        "GTPase IMAP family member 7-like_111112005"="GIMAP 7-like",
        ...
        "putative inhibitor of apoptosis_111101016"="putative IAP",
        "putative inhibitor of apoptosis_111101682"="putative IAP",
        ...
        "putative inhibitor of apoptosis_111104637 (1)"="putative IAP",
        "putative inhibitor of apoptosis_111104637 (2)"="putative IAP"))

#### analysis of ROD GIMAP and IAP genes independently ####
IAP_genes <- rbind(IAP, IAP2)

ggplot(IAP_genes) + geom_col(aes(x=description, y=log2FoldChange)) + theme(axis.text.x = element_text(angle = 75, hjust = 1)) + geom_hline(yintercept=0.0) +
  scale_y_continuous(name ="log2 Fold Change", breaks = scales::pretty_breaks(n = 20)) 


ggplot(GIMAP) +  geom_col(aes(x=description, y=log2FoldChange)) + theme(axis.text.x = element_text(angle = 75, hjust = 1)) + geom_hline(yintercept=0.0) +
  scale_y_continuous(name ="log2 Fold Change", breaks = scales::pretty_breaks(n = 20))
...
#Extract columns you want from the C_vir_TranscriptCountData, based on which column the correct SRA data
#NOT USING DAY 30 in ROD BECAUSE IN PROBIOTIC CHALLENGE IT WAS 5, 12, AND 16 DAYS
...
RIF_GIMAP_IAP_combined_SIG <- RIF_GIMAP_IAP_combined %>% filter(Significance == "significant")
#put two columns together to make the description column unique for the graphing process, use tidyr unite()
...
####RIF GIMAP and IAP plotting ####
RIF_IAP_genes <- rbind(RIF_IAP, RIF_IAP2)

ggplot(RIF_IAP_genes) + geom_col(aes(x=description, y=log2FoldChange)) + theme(axis.text.x = element_text(angle = 75, hjust = 1)) + geom_hline(yintercept=0.0) +
  scale_y_continuous(name ="log2 Fold Change", breaks = scales::pretty_breaks(n = 20)) 


ggplot(RIF_GIMAP) +  geom_col(aes(x=description, y=log2FoldChange)) + theme(axis.text.x = element_text(angle = 75, hjust = 1)) + geom_hline(yintercept=0.0) +
  scale_y_continuous(name ="log2 Fold Change", breaks = scales::pretty_breaks(n = 20))
