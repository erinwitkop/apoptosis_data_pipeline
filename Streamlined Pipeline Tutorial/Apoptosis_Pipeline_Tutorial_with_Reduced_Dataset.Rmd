...
knitr::include_graphics("apoptosis_data_pipeline/Streamlined Pipeline Tutorial/Transcriptome_pipeline.png"")
```
...
```{r, out.width="400px", out.height="400px", echo=FALSE, fig.align='center'}
knitr::include_graphics("apoptosis_data_pipeline/Streamlined Pipeline Tutorial/Genome_sequencing_bioproject.png")
```
...
```{r, out.width="400px", out.height="400px", echo=FALSE, fig.align='center'}
knitr::include_graphics("apoptosis_data_pipeline/Streamlined Pipeline Tutorial/SRA_accession_list.png")
```
