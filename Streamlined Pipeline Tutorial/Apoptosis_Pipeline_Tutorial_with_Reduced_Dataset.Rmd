...
Results are extracted using the function results(). This function extracts a results table with log2 fold changes,
p values and adjusted p values. Supply arguments to results to extract the comparisons you wish to make.
...
Differential analysis of count data - the DESeq2 package Michael Love, Simon Anders, Wolfgang
...
Klaus, Bernd. 2014.“Differential expression analysis of RNA-Seq data using DESeq2”. European Molecular
